...
export default async function handler(req, res) {
  ...
  try {
    ...
    let tokenData;
    const tokenUrl = process.env.APP_OAUTH_TOKEN_URL || `${origin}/api/auth/mock-idp?_sub=token`;
    ...
    // 5. Fetch userinfo
    const userinfoUrl = process.env.APP_OAUTH_USERINFO_URL || `${origin}/api/auth/mock-idp?_sub=userinfo`;
